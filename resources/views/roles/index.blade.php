    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">Kelola peran pengguna sistem</p>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-blue-500">
                    <tr>
                        <th class="px-6 py-3 text-center text-xs font-semibold text-white uppercase tracking-wider">Nama Role</th>
                            ...
                            <div class="flex items-center justify-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <div class="h-10 w-10 rounded-full bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center">
                                        <span class="text-white font-medium text-sm">{{ strtoupper(substr($role->name, 0, 1)) }}</span>
                                    </div>
                                </div>
                                <div class="ml-4">
                            ...
                            <div class="flex justify-center space-x-2">
                                ...
                                <form method="POST" action="{{ route('roles.destroy', $role) }}" class="inline">
                                    ...
                                    <button type="submit"
                                            ...
                                            onclick="return confirm('Yakin hapus role {{ $role->name }}?')">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
