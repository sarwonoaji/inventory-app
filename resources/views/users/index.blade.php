    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">Kelola pengguna sistem inventory</p>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-blue-500">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center text-xs font-semibold text-white uppercase tracking-wider">Email</th>
                        <th class="px-6 py-3 text-center text-xs font-semibold text-white uppercase tracking-wider">Role</th>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                ...
                                @elseif($user->role === 'penerimaan') bg-green-100 text-green-800
                                @elseif($user->role === 'pengeluaran') bg-red-100 text-red-800
