...
<div class="max-w-2xl bg-white p-6 rounded-xl shadow border border-gray-200">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500">Perbarui data master barang</p>
    </div>
    ...
    <form action="{{ route('barang.update', $barang->id) }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <input type="email"
                   name="supplier_email"
                   value="{{ old('supplier_email', $barang->supplier_email) }}"
                   class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
        ...
        <div>
            ...
            <textarea name="keterangan"
                      rows="3"
                      class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">{{ old('keterangan', $barang->keterangan) }}</textarea>
        </div>
